...
const CUSTOM_QUERIES = {
  ...
  'Funnel Set': 'funnel set automotive oil pour',
  ...
  'Basin Wrench': 'basin wrench plumbing tool long handle faucet nut',
  'Adjustable Wrench': 'adjustable wrench',
  'Drywall T-Square': 'drywall T-square',
  'Drywall Knife': 'drywall knife putty',
  'Drywall Lift': 'drywall lift panel hoist ceiling installation tool',
  'Mud Pan': 'drywall mud pan joint compound tool',
  'Rasp': 'rasp tool file woodworking product',
  ...
  'Mortar Hoe': 'masonry mixing hoe tool concrete mortar',
